...
def save_my_matchlist():
	res = requests.get("https://na1.api.riotgames.com/lol/match/v3/matchlists/by-account/32766?api_key=RGAPI-c87af80c-b252-479c-9ad6-644876477265")
	my_champs = res.json()
